...
pub use pallet_balances::Call as BalancesCall;
#[cfg(any(feature = "std", test))]
pub use pallet_aura::Call as AuraCall;
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("lobeke-node"),
	impl_name: create_runtime_str!("lobeke-node"),
	authoring_version: 1,
...
construct_runtime!(
	pub enum Runtime where
		Block = Block,
		NodeBlock = node_primitivess::Block,
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		TechnicalCouncil: pallet_collective,
